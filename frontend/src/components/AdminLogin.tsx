        ...
        <form className="space-y-6 mt-8" onSubmit={handleSubmit}>
          ...
          <div>
            ...
            <input
              ...
              placeholder="admin@expertly.com"
            />
          </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-gray-900 text-white py-3 px-6 rounded hover:bg-gray-800 disabled:opacity-50 transition-colors font-semibold"
          >
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-white text-gray-500">Or use SSO</span>
            </div>
          </div>
